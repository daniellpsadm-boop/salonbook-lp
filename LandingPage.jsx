        ...
        <div className="relative max-w-7xl mx-auto">
          ...
          >
            {[
              ...
              { name: 'Enterprise', price: 'R$397', per: '/mês', desc: 'Para redes, salões premium e barbearias', features: ['Profissionais ilimitados', 'Agenda online', 'Gestão de clientes', 'Agendamento automático pelo WhatsApp — 24h, 7 dias por semana', 'Controle financeiro completo da barbearia'] },
            ].map((p) => (
              <motion.div
                key={p.name}
                variants={fadeUp}
